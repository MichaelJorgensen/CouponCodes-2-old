...
public enum CommandUsage {
	C_ADD_ITEM	(ChatColor.YELLOW+"/c add item [name] [item1:amount,item2:amount..] (active) (usetimes) (time)"),
	C_ADD_ECON	(ChatColor.YELLOW+"/c add econ [name] [money] (active) (usetimes) (time)"),
	C_ADD_RANK	(ChatColor.YELLOW+"/c add rank [name] [group] (active) (usetimes) (time)"),
	C_ADD_XP	(ChatColor.YELLOW+"/c add xp [name] [xp] (active) (usetimes) (time)"),
